...
class PrestationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prestation" do
    assert_difference("Prestation.count") do
      post prestations_url, params: { prestation: { ClientName: @prestation.ClientName, Date: @prestation.Date, Description: @prestation.Description } }
    end
  ...
  test "should update prestation" do
    patch prestation_url(@prestation), params: { prestation: { ClientName: @prestation.ClientName, Date: @prestation.Date, Description: @prestation.Description } }
